...
if __name__ == "__main__":
    ...
    # r = 0, 不应调用np.random.uniform
    # r = 1000，np.exp可能发生溢出错误
    dim = np.array([train_x.shape[1]-1, 3, 1])
    layer_n = 3
    ...
    for i, val in enumerate(r):
        ...
        for n in range(times):
            w_arr = nnet_bp(train_x, train_y, layer=layer_n, dim=dim, eta=eta, r=val, T=50000)
    ...
    print(r[min_id])
'''
[ 0.4944   0.03688  0.03928  0.35328  0.49704]
0.001
'''