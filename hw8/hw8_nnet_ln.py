...
def backward(delta_list, w_list, s_list, x_list, y, layer, dim):
    ...
    for k in range(1, dim[layer-1]+1):
        delta_list[layer-1][k] = np.log2(2.718) * (-1*y)/(1 + np.exp(y*x_list[layer-1][k])) \
                                 * der_tanh(s_list[layer-1][k])
...
if __name__ == "__main__":
    file_train = 'hw4_nnet_train.dat'
    file_test = 'hw4_nnet_test.dat'
    ...
    print(err_avg)
'''
[ 0.036  0.24   0.036  0.032  0.036  0.032  0.032  0.036  0.032  0.244
  0.032  0.24   0.032  0.24   0.24   0.24   0.032  0.032  0.036  0.24
  0.032  0.032  0.032  0.032  0.032  0.036  0.24   0.24   0.036  0.032
  0.24   0.036  0.036  0.036  0.032  0.036  0.032  0.24   0.032  0.24
  0.036  0.032  0.04   0.032  0.032  0.032  0.24   0.032  0.04   0.032]
0.08744
'''
