...
if __name__ == '__main__':
    ...
    sign_pred_train = pred_sign(alpha_list, s_list, theta_list, i_list, data_x)
    err_train = get_err(data_y, sign_pred_train)

    sign_pred_test = pred_sign(alpha_list, s_list, theta_list, i_list, test_x)
    err_test = get_err(test_y, sign_pred_test)

    print(err_train)       # 0.0
    print(err_test)        # 0.132
